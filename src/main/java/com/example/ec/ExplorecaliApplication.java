...
public class ExplorecaliApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		System.out.println("run - entering");
		createTourPackages();
		long numOfTourPackages = tourPackageService.total();
		System.out.println("packages loaded = " + numOfTourPackages);
		createTours(importFile);
		long numOfTours = tourService.total();
		System.out.println("tours loaded = " + numOfTours);
		System.out.println("run - all done");
	}

	private void createTours(String fileToImport) throws IOException {
		System.out.println("createTours - entering");
		...
		System.out.println("createTours - all done");
	}
